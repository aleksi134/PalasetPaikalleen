...
const Results: React.FC<Props> = () => {
  ...
  return (
    <div className="container info-container">
      ...
      <p>
        Korkeakoulustartti – korkeakouluopintoihin suuntaava valmennus -hanke (ESR) 1.1.2018-31.12.2020. Toteuttajat Karelia-ammattikorkeakoulu ja Itä-Suomen yliopisto.
      </p>
      ...
      <p>
        Korkeakoulustartti-hankkeen videot:&nbsp;
