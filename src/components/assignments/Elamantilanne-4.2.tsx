...
const Assignment: React.FC<Props> = ({ state = [], done, cancel }) => {
  ...
  return (
    <div>
      <AssignmentInstructions title="Voimavarat">
      ...
      <IonList lines="none" className="ion-margin-vertical">
        ...
        <IonItem lines="inset">
          <IonInput
            ...
            placeholder="Esim. Kaverit"> </IonInput>
...

      {
        ...
        <IonCard>
          ...
          <IonCardContent>
            <p> Hienoa, nyt olet koonnut hyvän mielen reppuun niitä asioita, jotka tuottavat sinulle iloa, antavat energiaa ja auttavat jaksamaan. Voit pitää tätä listaa tallessa pahan päivän varalle, Hienoa, nyt olet koonnut hyvän mielen reppuun niitä asioita, jotka tuottavat sinulle iloa, antavat energiaa ja auttavat jaksamaan. Voit pitää tätä listaa tallessa pahan päivän varalle,   </p>
          </IonCardContent>
        </IonCard>
      }
